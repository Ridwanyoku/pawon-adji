...
<head>
    ...
    <title>Reset Password - Traditional Food Ecommerce</title>
</head>
    ...
    <div style="background-color: white; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); width: 100%; max-width: 400px;">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
                @error('email')
            ...
            <div style="text-align: center;">
                <button type="submit" style="background-color: #007bff; color: white; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer;">Reset Password</button>
            </div>
        </form>
    </div>
</body>
