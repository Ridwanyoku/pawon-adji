...
<body style="font-family: Arial, sans-serif; background-color: #f0f0f0; margin: 0; padding: 20px;">
    ...
    <main style="max-width: 800px; margin: 20px auto;">
        ...
        <form action="{{ route('seller.products.store') }}" method="POST" style="margin-bottom: 20px;">
            @csrf
                ...
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td style="padding: 10px;">
                            ...
                            <button type="submit" formaction="{{ route('seller.products.update', $product->id) }}" style="background-color: #007bff; color: white; padding: 5px 10px; border: none; border-radius: 5px; margin-left: 5px;">Simpan</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
